  ...
  return (
    <>
      <div className="container m-5 p-5">
        ...
        <div className="row border-top m-5 p-5">
          <div className="col-6 p-5" style={{lineHeight:"1.8"}}>
            <p>
          ...
          <div className="col-6 p-5"  style={{lineHeight:"1.8"}}>
            ...
            <p>
              And yet, we are always up to something new every day. Catch up on the latest updates on our <a href='https://zerodha.com/z-connect/' style={{ textDecoration: "none" }}>blog</a> or see what the media is <a href='https://zerodha.com/media' style={{ textDecoration: "none" }}>saying about us</a>.
            </p>
          </div>
        </div>
